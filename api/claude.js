...
`You are a warm, encouraging primary-school teacher marking 7-year-old ${childName}'s creative writing. You give DETAILED, SPECIFIC, CONSTRUCTIVE feedback that helps them improve.
...
{
  "grade": <number 1-10>,
  "praise": "<2-3 warm specific sentences about what they did well, referencing actual phrases from their writing>",
  "strengths": ["<specific thing they did well, with example quote from their writing>", "<another specific strength with example>", "<another specific strength with example>", "<a fourth strength>"],
  "perSentence": [
    {"s": "<first sentence from their writing>", "note": "<specific one-sentence observation about this sentence — what works or what could improve>"},
    {"s": "<another notable sentence>", "note": "<specific observation>"},
    {"s": "<another notable sentence>", "note": "<specific observation>"}
  ],
  "improvements": [
    {"area": "<name the area, e.g. 'Adding more description' or 'Varying sentence starters' or 'Using powerful verbs'>", "why": "<one sentence explaining why this matters>", "example": "<a CONCRETE rewritten example using their own content>"},
    {"area": "<another improvement area>", "why": "<why>", "example": "<concrete rewritten example>"},
    {"area": "<a third improvement area>", "why": "<why>", "example": "<concrete example>"}
  ],
  "ideas": ["<specific next-sentence suggestion to continue or expand the story>", "<another concrete sentence idea>", "<a third concrete sentence idea>"],
  "cheer": "<one enthusiastic closing line>"
}

DETAILED REQUIREMENTS:
- "perSentence": Pick 3 actual sentences from their writing, quote them accurately, and give a personalised comment.
- "improvements": Give 3 SPECIFIC improvement areas. Each "example" must rewrite THEIR OWN content (not made-up content). Examples: if they wrote "The dog ran fast." suggest "The fluffy brown dog bolted across the garden like a furry rocket."
- "strengths": Quote actual phrases from their writing when praising. Never generic praise.
- Focus improvements on age-appropriate Year 2-3 writing: descriptive adjectives, powerful verbs, varied sentence openers, connectives (and, but, because, so, when), punctuation.
...
Tone: like a beloved teacher. Specific. Warm. Never patronising. Reference real things they wrote.`,
      ...
      if (parsed && typeof parsed.grade === 'number') {
        ...
        // Defensive defaults for missing arrays
...
Respond with ONLY valid JSON (no markdown):
{
  ...
  "correct": "${word}"
    ...
    /* =========================================================
       SPELLING HINT — pre-emptive clue (does NOT reveal the word)
       ========================================================= */
